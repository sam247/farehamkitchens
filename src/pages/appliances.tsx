...
const Appliances = () => {
  return (
    <>
      <Head>
        <title>Kitchen Appliances | Fareham Kitchens</title>
        <meta
          name="description"
          content="Premium kitchen appliances from our Fareham showroom. AEG, Bora, Quooker, Miele, Gaggenau integrated into bespoke kitchens. Design and installation."
        />
        <link rel="canonical" href="https://farehamkitchens.co.uk/appliances" />
        <meta property="og:title" content="Kitchen Appliances | Fareham Kitchens" />
        <meta property="og:description" content="Premium kitchen appliances from our Fareham showroom. AEG, Bora, Quooker, Miele, Gaggenau integrated into bespoke kitchens." />
        ...
        <meta name="twitter:title" content="Kitchen Appliances | Fareham Kitchens" />
        <meta name="twitter:description" content="Premium kitchen appliances from our Fareham showroom. AEG, Bora, Quooker, Miele, Gaggenau integrated into bespoke kitchens." />
              ...
              <div className="lg:col-span-7 space-y-6">
                ...
                <AnimatedSection delay={0.2}>
                  <p className="body-elegant text-muted-foreground leading-relaxed">
                    We partner with the world&apos;s finest appliance manufacturers to ensure your kitchen is equipped with the very best. From <Link href="/" className="text-primary hover:underline">our Fareham showroom</Link> we source and integrate AEG, Bora, Quooker, Miele, and more—appliances that match the quality of our bespoke cabinetry.
                  </p>
                </AnimatedSection>
